...
import singleProductPage from "components/single-product-content";
import Image from "next/image";
import Link from "next/link";
import { useState, useEffect, useRef } from "react";

const productPage = ({ filt_data, proDataFiltCat }) => {
                        ...
                        <div class="flex justify-around">
                            <div class="flex flex-col justify-start w-7/12">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <button class="border border-sky-500 rounded-md flex flex-1 justify-center bg-sky-500 hover:bg-sky-600">
                            ...
                            <ul class="flex flex-col w-1/4 ">
                                <li class="flex justify-around mb-12">
                                ...
                                <li class="flex justify-around mb-12">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <div>
                                            <Image src={"https://www.lifepharmacy.com/images/payment-method.svg"} height={100} width={100} />
                                        </div>
                                    </div>
                                </li>
                                <li class="flex justify-around mb-12">
