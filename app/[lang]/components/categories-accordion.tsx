                                ...
                                <>
                                    ...
                                    <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm border-gray-200 border bg-slate-100 rounded-xl my-2  text-gray-500">
                                        <div className="grid lg:grid-cols-3 xl:grid-cols-3 md:grid-cols-3 gap-y-5 p-2">{cat_data.sections.map(ch_data => (
                                            <Link href={`${pathname?.substring(0, 6)}/home/${slugify(ch_data.name)}`}  className=" xl:flex mx-2  hover:bg-white rounded-lg p-2 hover:border-gray-200 hover:border border border-gray-50 group/item">
